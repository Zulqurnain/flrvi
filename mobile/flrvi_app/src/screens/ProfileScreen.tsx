...
import { View, Text, StyleSheet, ScrollView, Button, Image, Dimensions, ActivityIndicator } from 'react-native';
import { useDispatch, useSelector } from 'react-redux';
import { fetchUserProfile, likeUserProfile } from '../store/userSlice';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Like" onPress={handleLike} color="#E91E63" />
      </View>
    </ScrollView>
  );
};
